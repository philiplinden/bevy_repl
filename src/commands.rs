...
pub trait ReplExt {
    ...
    fn add_repl_command<C: ReplCommand>(&mut self, observer: impl Fn(Trigger<C>) + Send + Sync + 'static) -> &mut Self;
}
...
//     mut repl_text_buffer: ResMut<crate::tui::BevyRatatuiTerminal>,
