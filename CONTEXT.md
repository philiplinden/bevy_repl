...
**Toggle Key**:
The designated key (default: backtick) that triggers a `Lifecycle Event` to enable or disable the REPL, intercepted before it can be inserted into the buffer.
_Avoid_: Hotkey, activation key
